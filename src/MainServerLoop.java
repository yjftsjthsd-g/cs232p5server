...
public class MainServerLoop {
    ...
    void run() {
        ...
        while (true) { // inf. loop
            ...
            try { // on connection, sic a thread on it
                ...
                new Thread(new CaesarCipherCodingConnectionRunnable(
    ...
    private class CaesarCipherCodingConnectionRunnable implements Runnable {

        private int myRotationAmount;
        private Socket mySocket;

        public CaesarCipherCodingConnectionRunnable(Socket mySocket) {
